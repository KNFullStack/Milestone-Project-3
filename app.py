...
def dashboard():
    ...
    img = BytesIO()
    plt.pie(pie_chart_values_income, labels = pie_chart_label_income, autopct = "%2.0f%%", labeldistance=1.25, shadow=True)
    plt.tight_layout()
    ...
    img2 = BytesIO()
    plt.pie(pie_chart_values_outgoings, labels = pie_chart_label_outgoings, autopct = "%2.0f%%", labeldistance=1.25, shadow=True)
    plt.tight_layout()
